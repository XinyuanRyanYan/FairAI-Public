...
class LRChapter1:
    def __init__(self):
        ...
        self.df = pd.read_csv(path.join(APP_STATIC,"uploads/creditScore.csv"))
...
if __name__ == '__main__':
    LRChapter1 = LRChapter1()
    LRChapter1.split(split_ratio=0.5, keep_features=['gender', 'dependents', 'amount'])
    LRChapter1.train_model()
    LRChapter1.test_model()
