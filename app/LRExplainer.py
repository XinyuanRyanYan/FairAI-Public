...
class lrExplainer:
    def __init__(self):
        ...
        train_data = np.loadtxt(path.join(APP_STATIC,'uploads/credit.csv'), delimiter=',')
        test_data = np.loadtxt(path.join(APP_STATIC,'uploads/creditTest.csv'), delimiter=',')
...
if __name__ == '__main__':
    LRExplainerObj = lrExplainer()
    LRExplainerObj.train_model('')

    LRExplainerObj.test_model()
